...
import com.lwq.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchTests {
    ...
    public void testInsertList() {
        ...
        discussRepository.saveAll(discussMapper.selectDiscussPosts(159, 0, 100));
        discussRepository.saveAll(discussMapper.selectDiscussPosts(134, 0, 100));
    }

    @Test
    public void testUpdate() {
        DiscussPost post = discussMapper.findDiscussPostById(231);
