...
import com.lwq.entity.*;
import com.lwq.event.EventProducer;
import com.lwq.service.CommentService;
...
import com.lwq.util.RedisKeyUtil;
...
public class DiscussPostController  implements CommunityConstant {
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page){
        ...
        if(commentList!=null){
            for (Comment comment:commentList){
                ...
                commentVo.put("likeCount2",likeCount2);
                //点赞状态
                ...
                if(replyList!=null){
                    for (Comment reply:replyList){
                        ...
                        replyVo.put("likeCount3",likeCount3);
                        //点赞状态
                        likeStatus=hostHolder.getUser()==null?0:
    ...
    @ResponseBody
    public String setWoderful(int id){
